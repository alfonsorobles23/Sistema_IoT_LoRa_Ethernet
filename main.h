...
/* Private defines -----------------------------------------------------------*/
#define NRE485_Pin GPIO_PIN_13
#define NRE485_GPIO_Port GPIOC
#define DE485_Pin GPIO_PIN_15
#define DE485_GPIO_Port GPIOC
#define SPI2_NSS_Pin GPIO_PIN_0
#define SPI2_NSS_GPIO_Port GPIOF
#define SERIALSW_Pin GPIO_PIN_1
#define SERIALSW_GPIO_Port GPIOC
...
#define SERIALLB_Pin GPIO_PIN_1
#define SERIALLB_GPIO_Port GPIOA
...
#define SERIALMODE_Pin GPIO_PIN_5
#define SERIALMODE_GPIO_Port GPIOA
...
#define NTE485_Pin GPIO_PIN_12
#define NTE485_GPIO_Port GPIOA
